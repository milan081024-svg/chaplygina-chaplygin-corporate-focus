...
const Services = () => {
  const services = [{
    ...
    icon: Scale,
    title: "Услуги для нерезидентов и инвесторов",
    description: "Комплексное юридическое сопровождение иностранных инвесторов и компаний-нерезидентов: регистрация в РК, получение БИН, постановка на налоговый учет, оформление необходимых разрешений и лицензий, консультирование по инвестиционному законодательству."
  }, {
    icon: ClipboardCheck,
