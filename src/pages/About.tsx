            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-foreground/70">
                  Высочайший уровень экспертизы и постоянное развитие компетенций
                </p>
              </div>
              <div className="text-center">
                <div className="inline-flex h-16 w-16 items-center justify-center rounded-lg bg-accent/10 text-accent mb-4">
              ...
              <div className="text-center">
                ...
                <p className="text-foreground/70">
                  Абсолютная конфиденциальность и долгосрочные партнерские отношения
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <ul className="space-y-2 text-foreground/80">
                <li>Корпоративное структурирование и реорганизация компаний</li>
