...
const ru: Dict = {
  ...
  "services.s.seo.title": "SEO и аналитика",
  "services.s.seo.desc": "Техническая SEO-оптимизация, настройка аналитики, метрик и целей. Помогаем сайту находить и удерживать аудиторию.",
  ...
  "services.also.li.1": "Редизайн и модернизация существующих сайтов",
  "services.also.li.2": "Адаптация сайтов под мобильные устройства",
  "services.also.li.3": "Интеграция с CRM, ERP и сторонними сервисами",
  "services.also.li.4": "Подключение онлайн-оплаты и платёжных систем",
  "services.also.li.5": "Многоязычные сайты и локализация",
  "services.also.li.6": "Перенос сайтов между платформами и хостингами",
  "services.also.li.7": "Настройка SSL, защиты и резервного копирования",
  "services.also.li.8": "Подключение и настройка веб-аналитики (GA4, Яндекс.Метрика)",
  "services.also.li.9": "Создание и наполнение блога, новостных разделов",
  "services.also.li.10": "SEO-аудит и техническая оптимизация",
  "services.also.li.11": "Консультации по выбору технологий и подрядчиков",
  "services.also.li.12": "Сопровождение запуска и пост-релизная поддержка",
  ...
  "seo.home.title": "Chaplygina & Chaplygin – Веб-студия",
  ...
  "seo.about.desc": "Веб-студия Chaplygina & Chaplygin: команда дизайнеров и разработчиков, создающих современные сайты и цифровые продукты.",
  "seo.services.title": "Услуги – Chaplygina & Chaplygin",
  "seo.services.desc": "Разработка лендингов, корпоративных сайтов, интернет-магазинов и веб-приложений. UI/UX дизайн, SEO, поддержка и развитие.",
  "seo.contacts.title": "Контакты – Chaplygina & Chaplygin",
  "seo.contacts.desc": "Свяжитесь с веб-студией: info@chplgn.kz, +7 (701) 458-01-80, г. Актобе, ул. Маресьева 89.",
...
const en: Dict = {
  ...
  "services.s.seo.title": "SEO & analytics",
  "services.s.seo.desc": "Technical SEO, analytics setup, metrics and goal tracking. We help your site find and retain its audience.",
  ...
  "services.also.li.1": "Redesign and modernization of existing websites",
  "services.also.li.2": "Mobile adaptation of websites",
  "services.also.li.3": "Integrations with CRM, ERP and third-party services",
  "services.also.li.4": "Online payments and payment gateway setup",
  "services.also.li.5": "Multilingual websites and localization",
  "services.also.li.6": "Migration between platforms and hosting providers",
  "services.also.li.7": "SSL, security and backup configuration",
  "services.also.li.8": "Web analytics setup (GA4, Yandex.Metrica)",
  "services.also.li.9": "Blog and news section creation and content",
  "services.also.li.10": "SEO audit and technical optimization",
  "services.also.li.11": "Consulting on technology and vendor selection",
  "services.also.li.12": "Launch support and post-release maintenance",
  ...
  "seo.home.title": "Chaplygina & Chaplygin – Web Studio",
  ...
  "seo.about.desc": "Chaplygina & Chaplygin web studio: a team of designers and developers building modern websites and digital products.",
  "seo.services.title": "Services – Chaplygina & Chaplygin",
  "seo.services.desc": "Landing pages, corporate websites, online stores and web apps. UI/UX design, SEO, support and growth.",
  "seo.contacts.title": "Contact – Chaplygina & Chaplygin",
  "seo.contacts.desc": "Get in touch with the studio: info@chplgn.kz, +7 (701) 458-01-80, Aktobe, Maresyeva st. 89.",
